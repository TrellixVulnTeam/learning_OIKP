...
if __name__ == '__main__':
    t1 = time.time()
    func = partial(scrapping,"files/ladybug5.csv")  #인자하나 잡은 것을 부분함수화
    # for i in range(1,23):
    #    scrapping("files/ladybug4.csv",i)-> it takes 20 odds second.
    with multiprocessing.Pool(23) as p: # # of workers
